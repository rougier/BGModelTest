...
class RewardInSecondStep(object):
    ...
    def run(cls):
        ...
        for i in tqdm(range(t_max)):
            ...
            if decision_node == 0:
                ...
                while mot == -1:
                    ...
                    choice = model.choose(
                        possible_moves=np.array([1, 1, 0, 0], dtype=float),
                        possible_strategies=np.array([0, 1, 1, 1], dtype=float),
                    )
                    mot = choice["mot"]
                ...
                while mot == -1:
                    choice = model.choose(
                        ...
                        possible_strategies=np.array([0, 0, 1, 1], dtype=float),
                    )
                    mot = choice["mot"]
        ...
        return results_mot[-50:].count(1) / 10
...
class ProbabilisticRewardInSecondStep(object):
    ...
    def run(cls):
        ...
        return results_cog[-50:].count(1) / 10
